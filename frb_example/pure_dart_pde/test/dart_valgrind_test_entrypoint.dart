...
import 'api/feature_test.dart' as feature_test;
...
import 'api/pseudo_manual/feature_twin_sync_test.dart'
    as feature_twin_sync_test;
...
Future<void> callFileEntrypoints() async {
  ...
  await feature_test.main(skipRustLibInit: true);
  ...
  await feature_twin_sync_test.main(skipRustLibInit: true);
